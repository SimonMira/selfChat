...
public class DeleteFrag extends DialogFragment implements View.OnClickListener {
    ...
    public static DeleteFrag newInstance(OnLongClickListenerFromDeleteAdapter listener, Message msgToDelete) {

        Bundle args = new Bundle();
        args.putString("msg", msgToDelete.getMsg());
        args.putString("date", msgToDelete.getTime());
        args.putString("username", msgToDelete.getUser());
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.delete_msg, container, false);
